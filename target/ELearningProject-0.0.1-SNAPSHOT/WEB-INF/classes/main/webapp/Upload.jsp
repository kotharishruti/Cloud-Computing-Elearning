...
<h3 align="center"> <%out.print(name); %>...Upload a book to help other readers </h3>
	...
	<td style="padding:0 50px 20px 10px;" class = "w3-center">
          	<h4 style="margin-top: 15%;">Select the Category of your Book</h4>
          	<br/>
            <h4 style="margin-top: %;">
	...
	<td style="padding:0 50px 0 75px;" class = "w3-center ">
              ...
              <h4 style="margin-top: 10%;"></h4><input type="file" name="file_name" style="margin-left: 30%;"/>
              <input type="submit" class="button1" value="Upload" style="margin-left: 20%;">
